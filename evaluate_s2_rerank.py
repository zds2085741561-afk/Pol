"""Validation-selected trajectory-flow reranking for a frozen S2 student.

The S2 checkpoint and all model parameters remain frozen. Only the inference
...
def main():
    ...
    payload = {
        "variant": "S3 = S2 + trajectory-flow reranking",
    ...
    output = args.output or os.path.join(
        "results",
        f"S3_S2_plus_TrajectoryFlowRerank_{args.dataset}.json",
    )
