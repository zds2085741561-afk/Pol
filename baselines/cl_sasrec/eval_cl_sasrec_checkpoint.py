# -*- coding: utf-8 -*-
"""Evaluate a trained CL-SASRec checkpoint on the fixed test split only."""
...
from run_cl_sasrec import CLSASRec, TeaRecDataset, build_config, parse_args
...
def main():
    ...
    result_path = os.path.join(
        result_dir, f"CLSASRec_{config['dataset']}_test_only.json"
    )
    with open(result_path, "w", encoding="utf-8") as file:
        json.dump(payload, file, ensure_ascii=False, indent=2)

    print("=" * 70)
    print("[TEST ONLY] CL-SASRec")
